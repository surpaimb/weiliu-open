...
namespace Weiliu\Open\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('WeiliuOpen', $this->prepareHandlers([
            new StreamHandler(
                \sys_get_temp_dir() . '/weiliuopen/weiliuopen.log',
